...
//3. site vals
$html_title = $l->footertitle7.' | We-TeVe'; //Tap title
...
<?php } ?>
		...
		<div class='row'>
			...
			<h1><?php echo $l->footertitle7; ?></h1>
			<a href="http://www.spreeprint.de/" ><img src="<?php echo $_dhp;?>images/partner/spreeprint.png"/></a>
